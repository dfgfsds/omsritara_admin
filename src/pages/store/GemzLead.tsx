...
function GemzLead() {
    ...
    const { data: getGemzLeadData, isLoading }: any = useQuery({
        queryKey: ['getGemzLeadApiData'],
        queryFn: () => getGemzLeadApi()
    });
    ...
    const filteredData = getGemzLeadData?.data?.data?.filter((item: any) => {
        const searchMatch =
            ...
            item?.phone_no?.toString()?.includes(searchTerm) ||
    ...
    const handleDownloadExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Gemz Leads");
                    ...
                    <div className="flex flex-wrap flex-1 gap-3 items-center">
                        <div className="w-full md:max-w-sm">
                            <Search
                                ...
                                placeholder="Search Name, Phone, Location, Message..."
                            />
                        </div>
